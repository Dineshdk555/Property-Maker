...
function Cards() {
  ...
  return (
    <div className='cardsCarousel-container mx-auto max-w-screen-xl'>
      <div className='cardsCarousel py-4'>
        <div
          className='cardsSlides gap-4'
          style={{
        ...
        >
          {[...Array(5)].map((_, index) => (
            <div key={index} className='cardsSlide' style={{ width: `${100 / 3}%`, marginRight: 0 }}>
        ...
        <button className='cardsPrev' onClick={prevSlide}>
          &#10094;
        </button>
        <button className='cardsNext' onClick={nextSlide}>
          &#10095;
        </button>
      </div>
    </div>

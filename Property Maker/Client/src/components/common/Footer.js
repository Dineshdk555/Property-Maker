                ...
                <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                        ...
                        <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                            ...
                            <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                                <form className="w-full">
                                    ...
                                    >
                                        ...
                                        <button
                                            className="mt-1 w-full bg-teal-500 px-6 py-3 text-sm font-bold tracking-wide text-white transition-none hover:bg-teal-600 sm:mt-0 sm:w-auto sm:shrink-0"
                                        >
                                            Send Email
                                        </button>
                                    </div>
                            ...
                            <div className="col-span-2 sm:col-span-1">
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> NO 1 Places </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Land Consulting </a>
                                    </li>
                    ...
                    <div className="mt-8 border-t border-gray-100 pt-8">
                        <div className="sm:flex sm:justify-between">
                            <p className="text-xs text-gray-500">&copy; 2024. Property Maker. All rights reserved.</p>
